...
from muffin.train.train_utils import encode_multimodal_preference_sample
from muffin.data.datasets import SingleDataSourceDataset
from muffin.eval.muffin_inference_logp import get_batch_logps, pretty_print, get_multimodal_sample_logps, write_logp_to_preference_tsv
from muffin.train.train_utils import zephyr_preprocess
from muffin.eval.zephyr_mm_chat import init_zephyr_mm
...
class ZephyrPreferenceInferenceDataset(torch_data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        rej_data_dict, win_data_dict = encode_multimodal_preference_sample(
            sample, self.tokenizer, self.mm_cfg, preprocess_func=zephyr_preprocess)
        # print(f'Rej:')
...
if __name__ == '__main__':
    ...
    #     '/home/yutianyu/Zephyr_checkpoints/SFT_exp/zephyr_mm_12b_SFT-6node_5kPT_SFT_stage3-caterpillar-stage2_mix#caterpillar-stage3_lvis#caterpillar-stage3_svit#caterpillar-stage3_sharegpt4v#llava#unimm-chat-134#222#600#101#157#117/checkpionts/checkpoint-4000', tune_clip=True)
    model, img_processor, image_token_len, tokenizer = init_zephyr_mm(
        '/home/yutianyu/Zephyr_checkpoints/DPO_exp/zephyr_mm_12b_DPO-all_data_SFT-dpo_zephyr_2102-trs#dpo_zephyr_1065-trs#dpo_zephyr_2566-trs-2102#1065#2566/checkpoints/checkpoint-150', tune_clip=True)
    
    use_im_start_end = True

    data_dir = '/data/public/multimodal/multimodal_data/dpo/refined_test/'
    # tsv_files = ['muffin_rewrite_cvpr_dpo_with_per_token_vqa_logp_train-1401.tsv']
    tsv_files = ['muffin_rewrite-by_translate_cvpr_dpo_with_per_token_vqa_logp_train-1401.tsv']
    
    data_dir = '/data/public/multimodal/multimodal_data/dpo/DPO_preference_rewrite_cvpr_1020_1027-1124_good/'
    # tsv_files = ['muffin_rewrite-by_mianbi_cvpr_zj1020_zj1027-1124_dpo_with_per_token_vqa_logp_train-2102.tsv']
    tsv_files = ['muffin_rewrite-by_trans_cvpr_zj1020_zj1027-1124_dpo_with_per_token_vqa_logp_train-2102.tsv']
    ...
    for tsv_filename in tsv_files:
        ...
        #     tsv_filepath, f'{data_dir}/zephyr_stage3_4k_logp', logps, overwrite_logps=True)
        # write_logp_to_preference_tsv(
        #     tsv_filepath, f'{data_dir}/zephyr_stage3_4k_logp_by_trans', logps, overwrite_logps=True)
        # write_logp_to_preference_tsv(
        #     tsv_filepath, f'{data_dir}/zephyr_stage3_4k_logp_SFT', logps, overwrite_logps=True)
        write_logp_to_preference_tsv(
            tsv_filepath, f'{data_dir}/zephyr_stage3_4k_logp_SFT_by_trans', logps, overwrite_logps=True)
