...
* [2026.06.25] 🔥🔥🔥 MiniCPM-V 4.6 已正式合并至 Ollama 官方模型库，为 Ollama 用户带来高效的图像与视频理解能力。欢迎[体验](https://ollama.com/library/minicpm-v4.6)！
...
如需查看具体框架的部署和训练指南，请参考[训练和推理框架与 API 支持](#训练和推理框架支持)。
