...
class _Keywords(Enum):
    # Used as a sentinel to determine if nothing is provided as a argument for `value` in `Component.update()`
    NO_VALUE = "NO_VALUE"
    # Used to skip processing of a component's value (needed for generators + state)
...
class Chatbot(Changeable, Selectable, IOComponent, JSONSerializable):
    ...
    def __init__(
        ...
        # Parameter moved to Chatbot.style()
